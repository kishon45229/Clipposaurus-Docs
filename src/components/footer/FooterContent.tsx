...
export const FooterContent = () => {
    const { data, handleRedictToCurrentPageHome, handleRedirectToChangelog, handleRedirectToTermsOfService, handleRedirectToGitHub, handleRedirectToFAQ, handleRedirectToGitHubDiscussions, handleRedirectToCreateDrop, handleRedirectToUnlockDrop } = useFooter();
    const { columns } = data;
    const redirectHandlers = {
        "Create Drop": handleRedirectToCreateDrop,
        "Unlock Drop": handleRedirectToUnlockDrop,
        "Documentation": handleRedictToCurrentPageHome,
