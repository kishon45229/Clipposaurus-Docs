...
export const FooterLinks = React.memo(() => {
  const { handleRedirectToApp, handleRedirectToFAQ, handleRedirectToChangelog, handleRedirectToTermsOfService } = useRedirects();

  const links = [
    { label: "Home", onClick: handleRedirectToApp },
